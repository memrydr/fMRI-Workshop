...
basedir = '/Users/saraappleton-knapp/Documents/CHEAR/fMRI_workshop/data2/derivatives/task/'
...
for dir in barts:
    ...
    os.system("cp /usr/local/fsl/etc/flirtsch/ident.mat %s/reg/example_func2standard.mat"%(dir))
